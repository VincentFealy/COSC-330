...
System.out.println(" "+space[0][5]+" | " +space[1][5]+" | " +space[2][5]+"
| " +space[3][5]+" | " +space[4][5]+" | " +space[5][5]+" | "
+space[6][5]);
System.out.println(" "+space[0][4]+" | " +space[1][4]+" | " +space[2][4]+"
| " +space[3][4]+" | " +space[4][4]+" | " +space[5][4]+" | "
+space[6][4]);
System.out.println(" "+space[0][3]+" | " +space[1][3]+" | " +space[2][3]+"
| " +space[3][3]+" | " +space[4][3]+" | " +space[5][3]+" | "
+space[6][3]);
System.out.println(" "+space[0][2]+" | " +space[1][2]+" | " +space[2][2]+"
| " +space[3][2]+" | " +space[4][2]+" | " +space[5][2]+" | "
+space[6][2]);
System.out.println(" "+space[0][1]+" | " +space[1][1]+" | " +space[2][1]+"
| " +space[3][1]+" | " +space[4][1]+" | " +space[5][1]+" | "
+space[6][1]);
System.out.println(" "+space[0][0]+" | " +space[1][0]+" | " +space[2][0]+"
| " +space[3][0]+" | " +space[4][0]+" | " +space[5][0]+" | "
+space[6][0]);
System.out.println("---------------------------");
...
//puts the information through the check winner at to see if there is a
winner
...
System.out.println("If you would like to play again, enter 1, if not,
